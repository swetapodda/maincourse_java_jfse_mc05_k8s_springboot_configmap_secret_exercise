...
3. Navigate to maincourse_java_jfse_mc05_k8s_springboot_configmap_secret_exercise folder

    `cd maincourse_java_jfse_mc05_k8s_springboot_configmap_secret_exercise`
